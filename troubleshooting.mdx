...
Remember, if you can't find a solution to your problem in this guide, feel free to ask for help in our [Discord community](https://discord.gg/GHACsEaQ) or contact our [support team](mailto:hello@marmotte.io) if you're a paying customer.

## Issue isn't covered

If your issue isn't covered in the troubleshooting guide, you can:

- Check if there's already an answer to your question in the Frequently Asked Questions section.
...
- Join our [Discord community](https://discord.gg/GHACsEaQ) and ask for help.
